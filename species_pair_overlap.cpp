...
int main(int argc, char *argv[]) {
	...
	const char* directoryPath = "/home/jnawang/SDM_process/novel_community/species_pair_overlap_chunk/";  // Replace with the path to your desired directory  C:/Users/Junna/Box/Biodiversity/SDM/bin/
...
//
	...
	char  filename[100];
	sprintf(filename, "%s%s", "/home/jnawang/SDM_process/novel_community/species_pair_overlap_merge/", scenario);
	puts(filename);
