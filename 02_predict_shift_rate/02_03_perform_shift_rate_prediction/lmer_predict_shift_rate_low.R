...
data_env_lat$AreaF    <- as.factor(4)       # M: 1; F: 2; L: 4;
#
...
data_env_ele$Sampling <- as.factor("TWO")         # M:MULT; L:TWO; F:MULT
data_env_ele$StartF   <- as.factor(2)              # M: 3; L: 2; F: 4;
data_env_ele$Quality  <- as.factor("LOW")      # M: MODELED; L: LOW; F: RESURVEYED
...
write.csv(ShiftR_Final, 'pre_post_processing/02_predict_shift_rate/02_03_perform_shift_rate_prediction/Final_prediction_shift_rate_slow_2025.csv')
